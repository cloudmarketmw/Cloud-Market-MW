...
<html lang="en">
	<head>
	    ...
	    <title>Cloud Market Home Page</title>
		...
		<div class="row">
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading green">zatchipa zokha</h4>
						</div>
					</div>	
					<h6 class="text">find products easy on cloud market.</h6>
				</div>
			</div> .col -->
			...
			<!-- <div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">lets ADVERTISE YOUR PRODUCTS</h6>	
				</div>
			</div>.col -->
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					MK <?php echo htmlentities($row['productPrice']);?>			</span>
...
?>
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
			<a href="product-details.php?pid=<?php echo htmlentities($row['id']);?>">
				<img  src="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" data-echo="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>"  width="170" height="174" alt=""></a>
			</div><!-- /.image -->			
				...
				<img  src="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" data-echo="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>"  width="170" height="174" alt=""></a>					
									...
									<div class="col col-xs-6">
										<div class="product-info">
											...
											<div class="product-price">	
												<span class="price">
													MK <?php echo htmlentities($row['productPrice']);?>
												</span>
												<span class="price-before-discount">MK <?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>
