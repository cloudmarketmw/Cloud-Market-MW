...
?>
					...
					<div class="products">
						<div class="hot-deal-wrapper">
							<div class="image">
								<img src="admin/productimages/<?php echo htmlentities($rws['id']);?>/<?php echo htmlentities($rws['productImage1']);?>"  width="170" height="170" alt="">
							</div>
						...
						<div class="product-info text-left m-t-20">
							...
							<div >contacts: 0999920096/0984447390 <br><a href="http://localhost/cloud%20market/contacts.php">view more</a></div>

							<div class="product-price">	
								<span class="price">
									MK <?php echo htmlentities($rws['productPrice']);?>.00
								</span>
									
							    <span class="price-before-discount">MK<?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>					
...
<div class="stock-container info-container m-t-10">
							...
							<div class="stock-container info-container m-t-10">
								<div class="row">
									...
									<div class="col-sm-9">
										<div class="stock-box">
											<span class="value"><?php if($row['contactInfo']==0)
											{
												echo "Free";
											}
											else
											{
												echo htmlentities($row['contactInfo']);
											}
							...
							</div><a href="contacts.php">view more</a>
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
											<span class="price">MK <?php echo htmlentities($row['productPrice']);?></span>
											<span class="price-strike">MK <?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>
										</div>
									</div>
...
while($rw=mysqli_fetch_array($qry))
{
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					MK <?php echo htmlentities($rw['productPrice']);?>			</span>
										     <span class="price-before-discount">MK 
